  ...
  const header = <View style={styles.headerContent}>
    ...
    {!toolsCollapsed ? <>
      ...
      {categoryOpen ? <View style={styles.categoryPanel}>
        <View style={styles.categoryPanelHead}><Text style={styles.categoryPanelTitle}>Filter by category</Text></View>
...
const styles = StyleSheet.create({
  ...
  neutralTag: { alignItems: "center", alignSelf: "flex-start", backgroundColor: "#f4f5f3", borderColor: "#dfe4df", borderRadius: 12, borderWidth: 1, flexDirection: "row", gap: 7, paddingHorizontal: 9, paddingVertical: 6 },
  tag: { color: "#4f5d60", fontSize: 9, fontWeight: "900", letterSpacing: 0.8 },
  ...
  category: { color: "#596668", fontSize: 11, fontWeight: "800", marginTop: 4 },
