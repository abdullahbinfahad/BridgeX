...
export function MarketplaceScreen({ onOpenPost, onCreateRequest, onCreateCarry }: Props) {
  ...
  const filtered = useMemo(() => posts.filter(post => {
    ...
    return textMatch && (!category || categories.includes(category.toLowerCase()));
