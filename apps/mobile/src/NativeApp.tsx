...
import { Appearance, BackHandler, Image, Pressable, SafeAreaView, StyleSheet, Text, View } from "react-native";
...
const tabs = [
  { route: "marketplace", labelKey: "marketplace", icon: "compass-outline" },
  { route: "workspace", labelKey: "workspace", icon: "briefcase-outline" },
  { route: "messages", labelKey: "messages", icon: "chatbubbles-outline" },
  { route: "notifications", labelKey: "updates", icon: "notifications-outline" },
  { route: "more", labelKey: "more", icon: "grid-outline" },
] as const;
...
export default function NativeApp() {
  ...
  useEffect(() => {
    let active = true;
    if (!profile?.avatar_path) { setHeaderAvatarUrl(""); return () => { active = false; }; }
