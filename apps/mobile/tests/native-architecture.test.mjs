...
assert.match(workspaceRecords, /RecordActions/);
assert.match(workspaceRecords, /deleteNativeListing/);
...
assert.match(marketplace, /categoryIcon/);
assert.match(marketplace, /toolsCollapsed/);
