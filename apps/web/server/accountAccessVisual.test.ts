...
describe("BridgeX account-access delivery visual", () => {
  it("uses the optimized delivery animation as a complete trust-panel background without blocking account access", () => {
    expect(access).toContain("const ACCOUNT_ACCESS_DELIVERY_VISUAL = \"https://bridgexmp-fcp7rl7v.manus.space/manus-storage/bridgex-delivery-motion-original_add67cb7.webp\"");
