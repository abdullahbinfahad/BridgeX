...
type UpdateDestination = "profile" | "workspace" | "messages" | "admin";
type NotificationRecord = { id: string; type: string; link: string | null; title: string; body: string };
const emptyUpdateCounts: Record<UpdateDestination, number> = { profile: 0, workspace: 0, messages: 0, admin: 0 };
const emptyUpdateDetails: Record<UpdateDestination, NotificationRecord[]> = { profile: [], workspace: [], messages: [], admin: [] };
