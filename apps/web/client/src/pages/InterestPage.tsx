...
export default function InterestPage() {
  ...
  const [commercialUse, setCommercialUse] = useState("personal");
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    if (!declaredValue || !itemPurpose.trim() || !declarationConfirmed) return setMessage("Declare the item value, purpose, commercial-use status, and truthful-item confirmation before sending interest.");
