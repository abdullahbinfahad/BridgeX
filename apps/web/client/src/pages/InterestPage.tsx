...
type Listing = { id: string; user_id: string; origin_country: string; origin_city: string; destination_country: string | null; destination_city: string; available_weight_kg: number; departure_at: string; estimated_delivery_at: string | null; price_bdt: number; accepted_categories?: string[]; accepted_item_quantities?: Record<string, number> };
